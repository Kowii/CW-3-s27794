...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = emps.Where(obj => obj.Job == "SALESMAN").ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var grades = Database.GetSalgrades();
         ...
         var result = emps.Join(
                 ...
                 Where(obj => obj.emp.Sal >= obj.grade.Losal && obj.grade.Hisal >= obj.emp.Sal)
                 .Select(obj => new
                 {
                     obj.emp.EName,
                     obj.grade.Grade
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var mid = emps.Average(e => e.Sal);
        
        var result = emps.Where(emp => emp.Sal > emps.Where(e => e.DeptNo==emp.DeptNo).Average(e => e.Sal)).Select(e => e.EName); 
